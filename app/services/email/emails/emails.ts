...
export function generateCollaborationEmail(data: CollaborationEmailData): { html: string; text: string } {
      ...
      <html>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>This email was sent from the website collaboration form.</p>
