...
const LiatoshynskyOffice = async () => {
  ...
  const images: ImageData[] = [
    { src: '/images/office-media/lf-office-1.png', alt: 'Фото 1', styleKey: 'photo1' },
    { src: '/images/office-media/lf-office-2.png', alt: 'Фото 2', styleKey: 'photo2' },
    { src: '/images/office-media/lf-office-3.png', alt: 'Фото 3', styleKey: 'photo3' }
  ];
