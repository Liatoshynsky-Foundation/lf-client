...
jest.mock('./FoundationWasCreated/FoundationWasCreated', () => {
  const MockFoundationWasCreated = ({}: { data: TipTapDoc }) => (
    <div data-testid="foundation-was-created">
      <p>
        <span>
          <strong>{'The Liatoshynskyi Foundation, established'}</strong>
        </span>
        <span>
          {
            ' in 2023 by Tetyana Gomon, Iryna Tukova, and Pavlo Piminov, unites specialists in the fields of musicology, performing arts, music management, and digital projects.'
          }
        </span>
      </p>
    </div>
