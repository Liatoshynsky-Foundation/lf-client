...
export const faqItems = [
  {
    title: {
      en: 'Is it possible to get a refund for my donation?',
  ...
  {
    title: {
      en: 'Where will the received funds be spent?',
      uk: 'Куди будуть витрачені отримані кошти?'
    },
    content: {
      en: 'The received funds will be used for the implementation of the statutory areas of activity of the organization. The description of the projects we are working on and for which we are collecting funds appears on our website.',
      uk: 'Отримані кошти будуть використані для реалізації статутних напрямків діяльності організації. Опис проектів, якими ми займаємося і на які збираємо кошти, з’являється на нашому сайті.'
    }
  },
  {
    title: {
  ...
  {
    title: {
      en: 'I have signed up for a monthly payment, but I want to cancel it. How do I do that?',
  ...
  {
    title: {
      en: 'How can I change the amount of help or the bank card details for monthly support?',
  ...
  {
    title: {
      en: 'How can I help if I cannot make a contribution?',
  ...
  {
    title: {
      en: 'Where can I view the report on the use of collected funds?',
      uk: 'Де я можу ознайомитися зі звітом про використання зібраних коштів?'
    },
    content: {
      en: 'You can view the report on the use of collected funds on our website under the "Transparency" section.',
      uk: 'Ви можете переглянути звіт про використання зібраних коштів на нашому сайті в розділі "Прозорість".'
    }
  },
  {
    title: {
