...
export const biographyHeroData: BiographyHeroData = {
  quote: {
    quoteText: {
      uk: makeDoc([
        normalText(
          `..мене завжди цікавило і цікавить минуле людства. Цілі епохи, колись сповнені руху і життя, сповнені подій і думок людства,
          відійшли в минуле, залишивши тільки пам'ятки свого життя і діяльності. Століття... Тисячоліття...`
        )
      ]),
      en: makeDoc([
        normalText(
          `..I have always been deeply interested in the past of humankind. Whole eras, once full of movement and life, filled with events and human thought,
          have receded into the past, leaving only the traces of their life and work. Centuries... Millennia...`
        )
      ])
    },
    sourceText: {
      uk: makeDoc([normalText('З листа Бориса Лятошинського до Валерія Польового від 23 січня 1965 року')]),
      en: makeDoc([normalText('From a letter by Borys Lyatoshynsky to Valeriy Polyovyi, 23 January 1965')])
    }
  },
