...
jest.mock('~/infrastructure/models/events/events.model', () => ({
  __esModule: true,
  default: {
    find: jest.fn(),
    findOne: jest.fn()
...
describe('eventsRepository', () => {
  ...
  describe('getAllPublishedEvents', () => {
    it('should fetch and return all published events ordered by publication date', async () => {
      ...
      const result = await eventsRepository.getAllPublishedEvents();
  ...
  describe('getEventBySlug', () => {
    it('should fetch and return a specific event matching the slug', async () => {
      ...
      const result = await eventsRepository.getEventBySlug('target-slug');
